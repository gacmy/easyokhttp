...
public class EasyDownloadCallback implements Callback{
    ...
    public EasyDownloadCallback(DownloadResponseHandler downloadResponseHandler, String filePath, Long completeBytes) {
